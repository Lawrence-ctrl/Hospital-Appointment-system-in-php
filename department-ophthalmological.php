      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <h1 class="mb-3 bread">Ophthalomological Department</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            <p>
              <img src="images/thesis_img/ophthalomology.jpg" alt="" class="img-fluid">
            </p>
            <h2 class="mb-3">Ophthalomological Department</h2>
            <p>Ophthalmology is a branch of medicine dealing with the diagnosis, treatment and prevention of diseases of the eye and visual system.

            The eye, its surrounding structures and the visual system can be affected by a number of clinical conditions. Ophthalmology involves diagnosis and therapy of such conditions, along with microsurgery.</p>

            <p>Eye health services are becoming more and more important as the UK population ages. An ageing population means there are more and more incidences of age-related diseases of the eye, such as age-related macular degeneration. These eye diseases can be successfully treated if caught early, and can be managed effectively with existing treatments and medicines.</p>

            <p>Cataracts are the main cause of impaired vision worldwide, and in England and Wales it is estimated that around 2.5 million people aged 65 or older have some degree of visual impairment caused by cataracts. Cataract surgery is the second most common operation performed in the NHS in England – over 300,000 procedures are performed each year.</p>

            <p>Patients and members of the general public can view more information about eye conditions and treatments in our ‘For Patients‘ section.</p>
                       
            
            <div class="about-author d-flex p-4 mt-5 mb-5 bg-light">
              <div class="bio align-self-md-center mr-5">
                <img src="images/thesis_img/oph.jpg" alt="Image placeholder" class="img-fluid mb-4">
              </div>
              <div class="desc align-self-md-center">
                <h3>Dr. Barack</h3>
                <span class="position d-block mb-4">Head Doctor of Dental's Dept</span>
                <p>
            Our eyesight is our most important sense, and we all want to keep it healthy. If you wear glasses or contacts and have thought about improving your vision </p>
              </div>
            </div>
            ...
            <div class="row">
               <div class="col-md-6 ftco-animate">
                   <div class="block-2">
                     <div class="flipper">
                       <div class="front" style="background-image: url(images/thesis_img/oph2.jpg);">
                         <div class="box">
                           <h2>Johnson</h2>
                           <p>Ophthalmologist</p>
                         </div>
                       ...
                       <div class="back">
                         ...
                         <blockquote>
                           <p>&ldquo;
           Our eyesight is our most important sense, and we all want to keep it healthy. If you wear glasses or contacts and have thought about improving your vision &rdquo;</p>
                         </blockquote>
                         <div class="author d-flex">
                           <div class="image mr-3 align-self-center">
                             <div class="img" style="background-image: url(images/thesis_img/oph2.jpg);"></div>
                           </div>
                           <div class="name align-self-center">Johnson <span class="position">Ophthalmologist</span></div>
                         </div>
                       </div>
                     </div>
                   </div> <!-- .flip-container -->
                 ...
                 <div class="col-md-6 ftco-animate">
                   <div class="block-2">
                     <div class="flipper">
                       <div class="front" style="background-image: url(images/thesis_img/oph3.jpg);">
                         <div class="box">
                           <h2>Dr. Zooey</h2>
                           <p>Ophthalmologist</p>
                         </div>
            ...
            Our eyesight is our most important sense, and we all want to keep it healthy. If you wear glasses or contacts and have thought about improving your vision &rdquo;</p>
                         ...
                         <div class="author d-flex">
                           ...
                           <div class="name align-self-center">Dr. Zooey <span class="position">Ophthalmologist</span></div>
                         </div>
                       </div>
                     </div>
                   </div> <!-- .flip-container -->
