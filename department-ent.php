      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <h1 class="mb-3 bread">Ear Nose and Throat(ENT) Department</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            ...
            <h2 class="mb-3">Ear Nose and Throat(ENT) Department</h2>
            <p>ENT surgeons often treat conditions that affect the senses such as hearing and balance disorders or smell and taste problems. They also treat patients with conditions that affect their voice, breathing and swallowing as well as those with head and neck tumours including the skull base and interface with the brain.</p>

            <p>ENT surgeons may treat people of all ages from newborn babies to elderly people. They see more children than most other surgeons, apart from paediatric surgeons. One of the attractions is that they treat a wide spectrum of ages and diseases.</p>

            <p>A proportion of an ENT surgeon’s time is spent in outpatient clinics and managing conditions medically without the need for surgery. The use of microscopes & endoscopes in outpatients allows treatment/ diagnosis in the clinic. ENT has possibly the widest range of operations of any speciality from major head & neck procedures with flaps & complex reconstructions to microsurgery on the ear.</p>
         
            <div class="about-author d-flex p-4 mt-5 mb-5 bg-light">
              <div class="bio align-self-md-center mr-5">
                <img src="images/thesis_img/ent1.jpg" alt="Image placeholder" class="img-fluid mb-4">
              </div>
              <div class="desc align-self-md-center">
                <h3>Dr. Gennadi</h3>
                <span class="position d-block mb-4">Head Doctor of ENT's Dept</span>
                <p>
            “The most exquisite pleasure in the practice of medicine comes from nudging a layman in the direction of terror, then bringing him back to safety again.” </p>
              </div>
            </div>
            ...
            <div class="row">
               <div class="col-md-6 ftco-animate">
                   <div class="block-2">
                     <div class="flipper">
                       <div class="front" style="background-image: url(images/thesis_img/ent2.jpg);">
                         <div class="box">
                           <h2>Prof Dr. John F Robert</h2>
                           <p>ENT</p>
                         </div>
                       </div>
                       <div class="back">
                         ...
                         <blockquote>
                           <p>&ldquo;
            “The most exquisite pleasure in the practice of medicine comes from nudging a layman in the direction of terror, then bringing him back to safety again.” &rdquo;</p>
                         </blockquote>
                         <div class="author d-flex">
                           <div class="image mr-3 align-self-center">
                             <div class="img" style="background-image: url(images/thesis_img/ent2.jpg);"></div>
                           </div>
                           <div class="name align-self-center">Prof Dr. John F Robert<span class="position">ENT</span></div>
                         </div>
                       </div>
                     </div>
                   </div> <!-- .flip-container -->
                 ...
                 <div class="col-md-6 ftco-animate">
                   <div class="block-2">
                     <div class="flipper">
                       <div class="front" style="background-image: url(images/thesis_img/ent3.jpg);">
                         <div class="box">
                           <h2>Dr. Melville</h2>
                           <p>ENT</p>
                         </div>
            ...
            “The most exquisite pleasure in the practice of medicine comes from nudging a layman in the direction of terror, then bringing him back to safety again.” &rdquo;</p>
                         ...
                         <div class="author d-flex">
                           <div class="image mr-3 align-self-center">
                             <div class="img" style="background-image: url(images/thesis_img/ent3.jpg);"></div>
                           </div>
                           <div class="name align-self-center">Dr. Melville<span class="position">ENT</span></div>
                         </div>
                       </div>
                     </div>
                   </div> <!-- .flip-container -->
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <p>The most valuable is your health</p>
