...
<div class="hero-wrap" style="background-image: url('images/thesis_img/content.png'); background-attachment:fixed;">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></p>
   ...
   <section class="ftco-section contact-section ftco-degree-bg">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="col-md-3">
            <p><span>Phone:</span> <a href="tel://1234567920">+959986573412</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span> <a href="mailto:www.gmail.com">nobleclinic@gmail.com</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Website</span> <a href="localhost/appointment">yoursite.com</a></p>
          </div>
        </div>   
      </div>     
    </section>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="contact.php" id="appoint" method="POST">
